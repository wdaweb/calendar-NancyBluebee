...
<table class="TB_COLLAPSE" cellspacing="0">
  <caption>萬年曆設計<br><?php echo $year ?>年-<?php echo $month ?>月</caption>
  <thead>
    <tr>
    ...
    <h3>
        <a href="calendar2020.php?y=<?php echo $prevYear ?>&m=<?php echo $prevMonth ?>">上一月</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="calendar2020.php?y=<?php echo $nextYear ?>&m=<?php echo $nextMonth ?>">下一月</a>
    </h3>
    </div>
</body>
</html>